...
path1 = '.'
if(path.exists("mmm_gcmd.txt")):
    os.remove("mmm_gcmd.txt")
fo = open("mmm_gcmd.txt", "w+")
...
# if(path.exists("mmm_gcmd_counts_levels.txt")):
#     os.remove("mmm_gcmd_counts_levels.txt")

# sys.stdout = open("mmm_gcmd_counts_levels.txt", "w")
